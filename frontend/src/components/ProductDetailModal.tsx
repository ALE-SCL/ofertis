            ...
            <>
              ...
              <div className="bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 text-white rounded-2xl p-5 shadow-md flex flex-wrap items-center justify-between gap-4">
                <div>
                  ...
                  <div className="text-2xl sm:text-3xl font-black mt-2">
                    ...
                    <span className="text-sm font-semibold text-orange-100 ml-1">
                      / {product.standard_unit}
                    </span>
                  </div>
                  <p className="text-xs text-orange-100 mt-1 flex items-center space-x-1">
              ...
              <div>
                <h3 className="text-sm font-extrabold text-stone-900 uppercase tracking-wider mb-3 flex items-center space-x-1.5">
                  ...
                  <span className="text-xs font-normal text-stone-500">(Ordenado de menor a mayor precio por {product.standard_unit})</span>
                </h3>
                  ...
                  <table className="w-full text-left text-sm text-stone-600">
                    <thead className="bg-stone-100 text-xs font-bold text-stone-700 uppercase tracking-wider border-b border-stone-200">
                      <tr>
                        ...
                        <th className="py-3 px-4 text-orange-800 font-black">Precio /{product.standard_unit}</th>
                    ...
                    <tbody className="divide-y divide-stone-100">
                      {product.items.map((item, idx) => {
                        const isBest = idx === 0;
                        return (
                          <tr key={item.id} className={isBest ? 'bg-orange-50/50 font-semibold' : 'hover:bg-stone-50'}>
                            ...
                            <td className="py-3.5 px-4">
                              {item.current_offer_price ? (
                                ...
                                <span className="text-stone-400 text-xs">Sin descuento</span>
                              )}
                            </td>
                            <td className="py-3.5 px-4 text-stone-900 font-extrabold text-base">
