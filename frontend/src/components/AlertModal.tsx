...
export const AlertModal: React.FC<AlertModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-stone-900/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl max-w-md w-full shadow-2xl overflow-hidden border border-stone-200 animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6">
          {success ? (
            <div className="text-center py-6 space-y-3">
              <div className="w-14 h-14 bg-orange-50 text-orange-600 rounded-full flex items-center justify-center mx-auto border border-orange-200">
                <CheckCircle2 className="w-8 h-8" />
              </div>
              <h4 className="text-lg font-black text-stone-900">¡Alerta Suscrita con Éxito!</h4>
              ...
              <button
                onClick={onClose}
                className="mt-4 w-full bg-stone-900 text-white font-bold py-2.5 rounded-xl text-xs hover:bg-stone-800"
              >
                Entendido
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <span className="text-xs text-stone-500 font-semibold uppercase">Producto a Monitorear</span>
                <p className="text-sm font-bold text-stone-900">{productName}</p>
                {currentBestPrice > 0 && (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-stone-300 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <span className="text-[11px] text-stone-500">Formato chileno: +56 9 XXXX XXXX</span>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-7 pr-12 py-2.5 rounded-xl border border-stone-300 text-sm font-bold text-stone-900 focus:outline-none focus:ring-2 focus:ring-orange-500"
                    required
                  />
                  <span className="absolute right-3 top-2.5 text-stone-400 text-xs font-bold">CLP</span>
                </div>
              </div>
